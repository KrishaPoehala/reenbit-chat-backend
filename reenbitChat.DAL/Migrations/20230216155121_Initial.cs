    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatMember_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DefaultPermissionsId = table.Column<int>(type: "int", nullable: false),
                    RolesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissionRole", x => new { x.DefaultPermissionsId, x.RolesId });
                    table.ForeignKey(
                        name: "FK_PermissionRole_Permission_DefaultPermissionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatMemberPermission", x => new { x.MembersId, x.PermissionsId });
                    table.ForeignKey(
                        name: "FK_ChatMemberPermission_ChatMember_MembersId",
                        column: x => x.MembersId,
                        principalTable: "ChatMember",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatMemberPermission_Permission_PermissionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_ChatMember_SenderId",
                        column: x => x.SenderId,
                        principalTable: "ChatMember",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatMemberMessage", x => new { x.MessagesReadId, x.ReadById });
                    table.ForeignKey(
                        name: "FK_ChatMemberMessage_ChatMember_ReadById",
                        column: x => x.ReadById,
                        principalTable: "ChatMember",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatMemberMessage_Messages_MessagesReadId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMemberMessage_ReadById",
                table: "ChatMemberMessage",
                column: "ReadById");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMemberPermission_PermissionsId",
